            ...
            <section className=" bg-InitialImage relative z-10 bg-cover lg:grid grid-cols-2 lg:itens-center lg:justify-center 2xl:mx-auto pb-3 lg:pb-32">
                <section className='text-white pt-8 lg:pt-24 2xl:max-w-2xl 2xl:mx-auto 2xl:px-4'>
                    ...
                    <div className='hidden lg:block border-l-4 border-tertiaryOrange ml-6 mt-16 mb-20 text-2xl font-openSans'>
                        ...
                        <button className='uppercase text-white bg-primaryBlue hover:bg-white hover:text-primaryBlueDark ease-in-out duration-300 py-3 px-10 mt-4 ml-6'>Quero começar agora</button>
                    </div>
                </section>
                <picture>
