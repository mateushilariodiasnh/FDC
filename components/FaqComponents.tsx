        ...
        <div className="space-y-6 font-openSans font-normal text-primaryGrayDark divide-y divide-tertiaryGrayBlue w-full max-w-2xl lg:px-8S">
            <button onClick={() => setClickArrow(!clickArrow)} className="text-start w-full flex space-x-6 items-center">
                <p className="grow font-openSans text-1.5xl font-bold flex space-x-4">
                    <span className="text-tertiaryOrange pl-6">{data.number} </span>
            ...
            <p className={`pt-6 ${clickArrow ? "hidden" : "block"} mx-6 text-1.5xl font-openSans font`}>{data.content}</p><br></br>
