    ...
    return (
        <section>
            <div id='suaEmpresaEUnica' className='text-center font-nexaSlab mt-16'>
                <div className='border-t-8 border-white m-6 lg:max-w-3xl lg:mx-auto'></div>
                <h2 className='uppercase text-primaryBlue mt-10 mb-2 text-2xl lg:text-4xl'>Sua empresa é única</h2>
                <p className='text-primaryBlueDark mx-8 mb-8 '>É por isso que a jornada dela também tem de ser</p>
                <div className='border-t-8 border-white m-6 lg:max-w-3xl lg:mx-auto'></div>
            </div>
            <section className='relative overflow-hidden'>
                <div className='mx-6 my-10 lg:grid lg:grid-cols-2 lg:max-w-3xl lg:mx-auto lg:space-x-6 lg:space-y-6'>
                    <div className='lg:pl-6 z-10 font-openSans text-primaryGrayDark'>
