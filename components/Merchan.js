            ...
            <section className='bg-sky-800'>
                <div className='m-auto pt-16 pb-16 max-w-2xl '>
                    ...
                    <div className='border-l-4 border-[#FAA635] ml-6 mt-12 mb-20 font-openSans'>
                        <p className='ml-6 text-[#FFFFFF] mx-6 text-base lg:text-lg'>Cadastre-se agora mesmo e faça a <strong>avaliação de maturidade</strong> da sua empresa <strong>gratuitamente.</strong> </p>
