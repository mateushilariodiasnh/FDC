            ...
            <div className='m-auto pb-16 max-w-2xl lg:max-w-3xl pt-16 lg:py-32'>
                ...
                <div className='border-l-4 border-tertiaryOrange ml-6 mt-8 font-openSans'>
                    ...
                    <Link href='#' className="flex pointer-events-none">
                        <span className='uppercase text-white bg-primaryBlue py-3 px-10 lg:px-8 mt-4 ml-4 mr-4 hover:bg-white hover:text-primaryBlueDark ease-in-out duration-300 font-bold text-1.5xl font-openSans pointer-events-auto'>Quero começar agora</span>
                    </Link>
                </div>
            </div>
        </section>
