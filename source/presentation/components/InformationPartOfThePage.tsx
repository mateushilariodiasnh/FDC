    ...
    return (
        <section id='suaEmpresaEUnica' className="mt-16 lg:mt-14">
            <div className='text-center font-nexaSlab'>
                ...
                <p className='text-primaryBlueDark mx-8 mb-7 text-1.5xl lg:text-1xl'>É por isso que a jornada dela também tem de ser</p>
                <div className='border-t-8 border-white m-6 lg:max-w-3.5xl lg:mx-auto'></div>
            </div>
            <section className='relative overflow-hidden'>
                <div className='mt-4 lg:mt-1 lg:grid lg:grid-cols-2 lg:max-w-3xl lg:mx-auto lg:space-x-6 lg:space-y-6'>
                    <div className='mx-6 z-10 font-openSans text-primaryGrayDark text-1.5xl'>
                        ...
                        <p className='lg:grid-cols-1 pt-4 lg:pt-4'>Seu time ainda pode adicionar módulos de interesse de acordo com a cultura e as necessidades pontuais da organização, formando uma <strong>grade curricular flexível.</strong> </p>
                    </div>
                ...
                <div className='relative items-center justify-center lg:flex pt-40 lg:pt-36 pb-2 lg:pb-0'>
                    ...
                    <picture className="absolute z-30 w-80 top-32 left-16 lg:top-12 lg:right-12 lg:left-auto lg:w-151 2xl:top-20 2xl:right-40 ">
                    ...
                    <picture className="absolute z-20 lg:top-24">
