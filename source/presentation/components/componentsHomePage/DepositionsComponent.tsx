    ...
    return (
        <div className={className}>
            <div className="bg-white border-2 border-secondaryGrayMedium text-primaryGrayDark flex flex-col h-full lg:w-full">
                <div className=" border-t-8 border-tertiaryOrange mx-6 mt-4 lg:mt-6 lg:mx-8"></div>
                <div className="relative">
                    <QuotationMarks className="h-7 w-10 absolute top-5 left-8 z-10" />
                    <p className="pl-14 pr-8 lg:pr-8 lg:mr-8 mt-6 relative z-20 text-1.5xl font-normal font-openSans text-primaryGrayDark"> {data.text}</p><br></br>
                </div>
