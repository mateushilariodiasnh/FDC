...
export default function Foother(): JSX.Element {
    return (
        <footer>
            <div className='bg-white text-center pt-10 lg:pt-16 text-primaryGrayDark mb-10 lg:mb-0 lg:flex lg:py-16 lg:items-center lg:justify-center pb-8 lg:text-start lg:mx-4 xl:mx-20 xl:space-x-12 2xl:space-x-24'>
