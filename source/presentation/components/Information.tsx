    ...
    return (
        <section id='suaEmpresaEUnica' className="pt-6">
            ...
            <section className='relative overflow-hidden'>
                <div className='mt-4 lg:grid lg:grid-cols-2 lg:max-w-3xl lg:mx-auto lg:space-x-6 lg:space-y-6 mb-24'>
                ...
                <span className='top-96 lg:top-80 aria-hidden:"true" absolute px-2 items-center justify-center h-full w-full mx-auto '>
                ...
                <div className='relative items-center justify-center flex pt-40 lg:pt-32'>
                    ...
                    <picture className="absolute z-30 w-80 top-12 right-1 lg:right-0 lg:left-auto lg:w-[520px] 2xl:top-20 2xl:right-40 ">
